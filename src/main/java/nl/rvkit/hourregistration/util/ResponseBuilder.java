...
public class ResponseBuilder<T> {
    ...
    public static <T> ResponseBuilder<T> noContent() {
        return new ResponseBuilder<>(HttpStatus.NO_CONTENT.value());
    }

    public static <T> ResponseBuilder<T> imATeaPot() {
        return new ResponseBuilder<>(HttpStatus.I_AM_A_TEAPOT.value());
    }
